...
module slider() {
    difference() {
        union() {
            difference() {
            translate([0, 49.82, 8]) rotate([0, 0, 90]) mirror([0, 1, 0]) Rahmen();
            ...
            translate([-22, 0, 8]) cube([44, 4, 5]);
        }
        translate([0, 7.3+11.5, -1]) rotate([0, 0, 30]) cylinder(d=6.3, h=9.05, $fn=6);
        translate([-16.5, 4.3+7, -1]) cylinder(d=6.3, h=9.05, $fn=6);
        for (i=[0, 1]) {
        ...
        translate([0, 8, 0]) belt_clamp_stamp();
        translate([0, 81.5, 14.25]) rotate([-90, 0, 0]) belt_clamp_stamp();
        for (i=[-1, 1]) {
            translate([i*(6.4/2+0.5+6/2), 8, 0]) cylinder(d=3.23, h=50, $fn=32);
            translate([i*(6.4/2+0.5+6/2), 8, 13-2.8]) cylinder(d=6.4, h=50, $fn=6);
            translate([i*(6.4/2+0.5+6/2), 81.5-7.6, 14.25]) rotate([-90, 0, 0]) cylinder(d=3.23, h=50, $fn=32);
            translate([i*(6.4/2+0.5+6/2), 81.5-7.6, 14.25]) rotate([-90, 30, 0]) cylinder(d=6.4, h=2.8, $fn=6);
            translate([i*(6.4/2+0.5+6/2), 81.5-7.6+2.8/2, 14.25+20+1.5]) cube([5.56, 2.8, 40], center=true);
        }
        for (i=[0, 60]) {
            for (j=[0, 1]) {
...
module belt_clamp(use_stamp=false) {
    difference() {
        ...
        if (use_stamp) {
            translate([0, 9.3, 7.5]) rotate([0, 180, 90]) belt_stamp(6.4);
        } else {
...
module belt_clamp_stamp() {
    hull() {
            for (i=[-1, 1]) {
                translate([i*(6.4/2+0.5+6/2), 0, 0]) cylinder(d=8.7, h=7.5, $fn=32);
                for (j=[-1, 1]) {
...
slider();
color("green") translate([0, 8, 0]) belt_clamp(true);
